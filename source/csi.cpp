...
namespace ghostfs {
  namespace csi {
    ...
    public:
      Status GetPluginInfo(ServerContext* context, const ::csi::v1::GetPluginInfoRequest* request,
      ...
      Status Probe(ServerContext* context, const ::csi::v1::ProbeRequest* request,
    ...
    public:
      ...
      Status NodePublishVolume(ServerContext* context,
        ...
        std::thread mount_thread([=]() {
          ...
          int result
              = start_fs((char*)"ghostfs",  // executable name (not used)
                         target, options, host, port, user, token, write_back, read_ahead, cert);
...
#  endif
      ...
      Status NodeGetInfo(ServerContext* context, const ::csi::v1::NodeGetInfoRequest* request,
