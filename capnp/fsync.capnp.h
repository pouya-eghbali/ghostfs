...
struct Fsync::FuseFileInfo {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(b8aa2584ec15c2b3, 12, 0)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
inline  ::int64_t Fsync::FuseFileInfo::Reader::getFlags() const {
  return _reader.getDataField< ::int64_t>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}

inline  ::int64_t Fsync::FuseFileInfo::Builder::getFlags() {
  return _builder.getDataField< ::int64_t>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}
inline void Fsync::FuseFileInfo::Builder::setFlags( ::int64_t value) {
  _builder.setDataField< ::int64_t>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS, value);
}
