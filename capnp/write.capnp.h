...
struct Write {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(931883f8920c7515, 3, 2)
    #if !CAPNP_LITE
...
struct Write::FuseFileInfo {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(8b019c210166c03d, 12, 0)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
inline  ::int64_t Write::FuseFileInfo::Reader::getFlags() const {
  return _reader.getDataField< ::int64_t>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}

inline  ::int64_t Write::FuseFileInfo::Builder::getFlags() {
  return _builder.getDataField< ::int64_t>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}
inline void Write::FuseFileInfo::Builder::setFlags( ::int64_t value) {
  _builder.setDataField< ::int64_t>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS, value);
}
